...
\begin{frame}{New Paradigm: classify text attributes $\Rightarrow$ filter entries}{\subtitlecite{zhang-bethard-2024}}
\begin{tikzpicture}[
...
\begin{frame}{Predicting executable structure $>$ network reasoning}{\subtitlecite{zhang-bethard-2024}}
