...
\node (chatgpt) {\includegraphics[width=.6\textwidth]{chatgpt/calendar.png}};
\pause
\node[draw] (calendar) at (chatgpt) {\includegraphics[width=.3\textwidth]{calendar/2025-01-MO-FR.png}};
\end{tikzpicture}
\end{frame}
...
\centering
\begin{tikzpicture}[inner sep=0pt]
\node (chatgpt) {\includegraphics[width=.7\textwidth]{chatgpt/map.png}};
\pause
\node[draw] (map) at (chatgpt.south) {\includegraphics[width=.3\textwidth]{compgeo/map-biancavilla-out.png}};
\end{tikzpicture}
\end{frame}
...
\textit{six days ago} & $\Rightarrow$ & 2024-02-07 & $\Rightarrow$ & \raisegraphics{.4}{width=.1\textwidth}{calendar/2024-02-07.png} \\ \\
