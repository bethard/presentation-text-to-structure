...
\node[draw, font=\footnotesize, text width=.4\textwidth, label=Question] (question) at (0, 0) {%
What was George Washington’s \textcolor{ua-oasis}{position} from \textcolor{ua-red}{1790 - 1797}?};

\node[draw, font=\footnotesize, text width=.4\textwidth, below=3ex of question, label=Context] (context) {%
...
He started as the \textcolor{ua-oasis}{president} of United Sates in \textcolor{ua-red}{Jan 1788}, \ldots in \textcolor{ua-red}{1798, one year after that}, he stepped down his \textcolor{ua-oasis}{presidency} position.};

\node[draw, fill=black!25, align=center, inner sep=5pt, right=of question] (model)  {Language \\ Model};

\node[draw, font=\footnotesize, text width=.12\textwidth, label=Answer, right=of model] (answer) {%
